...
-(void)injectPatches
{
	// called to inject any INSPIRED patches in JS before a context is loaded... nice for 
...
-(id)require:(KrollContext*)kroll path:(NSString*)path
{
	...
	@throw [NSException exceptionWithName:@"org.inspired.kroll" reason:[NSString stringWithFormat:@"Couldn't find module: %@",path] userInfo:nil];
}
